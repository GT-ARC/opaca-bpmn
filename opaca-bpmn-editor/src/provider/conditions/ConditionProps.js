...
import {
    createElement, getEventDefinition
} from '../util';
...
function VariableEvents(props) {
    ...
    const tooltipContent = translate('Specify more than one variable change event as a comma separated list. Variable change events are:') +
        '\n' +
        translate('Variable events are:') +
        '\n' +
        '- create\n' +
        '- update\n' +
        '- delete\n' +
        translate('Documentation: Variable events') + ': https://docs.camunda.org/manual/latest/reference/bpmn20/custom-extensions/extension-attributes/#variableevents';
